...
export class PositionPage {
  ...
  constructor(public navCtrl: NavController, public positionService: PositionService) {

  }
  ngOnInit() {
    this.lineChartData = this.positionService.getLineData();
    this.barChartData = this.positionService.getBarData();
  }
